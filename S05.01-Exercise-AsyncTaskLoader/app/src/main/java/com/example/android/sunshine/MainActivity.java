...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int FETCHDATA_LOADER = 22;
    ...
    @NonNull
    @Override
    public Loader onCreateLoader(int i, final @Nullable Bundle bundle) {
        ...
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                String location = bundle.getString(LOCATION_EXTRA);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        queryBundle.putString(LOCATION_EXTRA, locationQuery);
        LoaderManager loaderManager = getSupportLoaderManager();
        loaderManager.initLoader(FETCHDATA_LOADER,queryBundle,this);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            Bundle queryBundle = new Bundle();
            queryBundle.putString(LOCATION_EXTRA, locationQuery);
            getSupportLoaderManager().restartLoader(FETCHDATA_LOADER, queryBundle, this);
            return true;
        }
